...
export default function AboutPage() {
  return (
    <main className="bg-white">
      <section className="bg-[#063f2c] px-5 py-12 text-white sm:px-8 sm:py-16"><div className="mx-auto max-w-4xl text-center"><h1 className="text-2xl font-black tracking-[-0.04em] sm:text-4xl">About Tips Deck</h1></div></section>
