...
export default async function AdminPredictionsPage() {
  ...
  return (
    <main className="mx-auto max-w-7xl px-5 py-10 sm:px-8 sm:py-14">
      <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between"><div><p className="text-xs font-black uppercase tracking-[0.14em] text-emerald-600">Content desk</p><h1 className="mt-2 text-4xl font-black tracking-[-0.05em] text-slate-950">Predictions</h1><p className="mt-3 text-sm text-slate-500">Create, edit and control what appears on the public tips board.</p></div><Link href="/admin/predictions/new" className="inline-flex min-h-11 items-center justify-center rounded-xl bg-[#078a4f] px-5 text-sm font-black text-white">New prediction</Link></div>
